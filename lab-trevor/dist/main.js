    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement('input', { type: 'text', name: 'search'
          ...
          , placeholder: 'search' }),
        _react2.default.createElement('input', { type: 'number', name: 'limit',
          min: '1',
          max: '100',
          placeholder: '1-100'
...
var SearchResults = function (_React$Component) {
  ...
  _createClass(SearchResults, [{
    ...
    value: function listResults() {
      return this.props.topics.map(function (result, i) {
        return _react2.default.createElement(
          "a",
          { href: result.data.url, target: "_blank" },
          _react2.default.createElement(
            "li",
            { key: i },
            result.data.title
...
var _SearchForm = __webpack_require__(/*! ./components/SearchForm */ "./src/components/SearchForm.js");
...
var App = function (_React$Component) {
  ...
  _createClass(App, [{
    key: 'performSearch',
    value: function performSearch(query, limit) {
      var _this2 = this;

      console.log('limit', limit);
      fetch('http://www.reddit.com/r/' + query + '.json?limit=' + limit).then(function (results) {
        console.log(results);
        return results.json();
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_SearchResults2.default, { topics: this.state.topics })
      );
    }
  }]);
